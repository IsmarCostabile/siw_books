...
public class UserViewController {
    ...
    public String showProfile(Model model, HttpSession session, RedirectAttributes redirectAttributes) {
        ...
        Optional<User> userWithReviews = userService.findByIdWithReviews(loggedInUser.getId());
        if (userWithReviews.isPresent()) {
            model.addAttribute("user", userWithReviews.get());
            model.addAttribute("reviews", userWithReviews.get().getReviews());
        } else {
    ...
    public String showPublicProfile(@PathVariable String username, Model model, HttpSession session) {
        ...
        // Add user and reviews to model
        model.addAttribute("user", profileUser);
        model.addAttribute("reviews", profileUser.getReviews());
